...
# 이미지 로드
image = cv2.imread('./dataset/train/image_png/TS_A9_png_removed/A9C_20221124_000000.png')

# YAML 파일 읽기
with open('./dataset/train/label_yaml/TL_A9_1_removed/A9C_20221124_000000.yaml', 'r') as yaml_file:
...
center_x, center_y, normalized_width, normalized_height = convert_to_yolo(x, y, width, height, image_width, image_height)
print(center_x)
print(center_y)
